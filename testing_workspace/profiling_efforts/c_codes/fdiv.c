...
int main(int argc, const char **argv)
{
    ...
    asm volatile(
        // ____ Pre Loop ____
        "fld %0\n\t" // Load dividend onto FPU stack
        "fld %1\n\t" // Load divisor onto FPU stack
        ...
        "mov $" XSTR(LOOPS) ", %%ecx\n\t" // i = LOOPS;
                            ...
                            ".rept " XSTR(REPEAT) "\n\t"
                                                  ...
                                                  "fdiv\n\t"    // Divide the two values on the FPU stack
                                                  "fstp %0\n\t" // Store the result back in dividend
                                                  ".endr;"
